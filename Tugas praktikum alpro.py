...
#soal Budi tertarik untuk melamar pekerjaan pada liburan semester yang akan berlangsung selama 5 minggu. Gaji 
# yang diberikan adalah gaji per jam. Total pajak yang harus budi
...
jumlah_uang_untuk_membeli_pakaian=pendapatan_budi_setelah_membayar_pajak * 0.1
jumlah_uang_untuk_membeli_alat_tulis=pendapatan_budi_setelah_membayar_pajak* 0.01
sisa_uang=pendapatan_budi_setelah_membayar_pajak-(jumlah_uang_untuk_membeli_pakaian + jumlah_uang_untuk_membeli_alat_tulis)
jumlah_uang_sedekah=sisa_uang * 0.25
jumlah_uang_yang_di_terima_anak_yatim=jumlah_uang_sedekah * 0.3
jumlah_uang_yang_diterima_kaum_dhuafa=jumlah_uang_sedekah - jumlah_uang_yang_di_terima_anak_yatim
...
print('jumlah uang untuk membeli pakaian=',jumlah_uang_untuk_membeli_pakaian)
print('jumlah uang untuk membeli alat tulis=',jumlah_uang_untuk_membeli_alat_tulis)
print('sisa uang budi=',sisa_uang)
print('jumlah uang sedekah=',jumlah_uang_sedekah)
print('jumlah uang yang di terima anak yatim=',jumlah_uang_yang_di_terima_anak_yatim)
print('jumlah uang yang diterima kaum dhuafa=',jumlah_uang_yang_diterima_kaum_dhuafa)